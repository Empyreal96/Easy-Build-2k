...
//
// MessageId: ID_DSP_TXT_15BIT_COLOR
//
// MessageText:
//
//  High Color (15 bit)
//
#define ID_DSP_TXT_15BIT_COLOR           0x00000005L

//
// MessageId: ID_DSP_TXT_16BIT_COLOR
//
// MessageText:
//
//  High Color (16 bit)
//
#define ID_DSP_TXT_16BIT_COLOR           0x00000006L

//
// MessageId: ID_DSP_TXT_TRUECOLOR24
//
// MessageText:
//
//  True Color (24 bit)
//
#define ID_DSP_TXT_TRUECOLOR24           0x00000007L

//
// MessageId: ID_DSP_TXT_TRUECOLOR32
//
// MessageText:
//
//  True Color (32 bit)
//
#define ID_DSP_TXT_TRUECOLOR32           0x00000008L
...
//  %1!d! by %2!d! pixels
//
#define ID_DSP_TXT_XBYY                  0x00000009L
...
//  %1!d! Hertz
//
#define ID_DSP_TXT_FREQ                  0x0000000AL
...
//  %1!d! MB
//
#define MSG_SETTING_MB                   0x0000000BL
...
//  %1!d! KB
//
#define MSG_SETTING_KB                   0x0000000CL
...
//
#define ID_DSP_TXT_COLOR_MODE            0x0000000DL
...
//
#define ID_DSP_TXT_TRUE_COLOR_MODE       0x0000000EL
...
//
#define ID_DSP_TXT_COLOR_MODE_INT_REF    0x0000000FL
...
//
#define ID_DSP_TXT_TRUE_COLOR_MODE_INT_REF 0x00000010L
...
//
#define ID_DSP_TXT_COLOR_MODE_DEF_REF    0x00000011L
...
//
#define ID_DSP_TXT_TRUE_COLOR_MODE_DEF_REF 0x00000012L
...
//
#define ID_DSP_TXT_INTERLACED            0x00000013L
...
//
#define ID_DSP_TXT_DEFFREQ               0x00000014L
...
//
#define ID_DSP_TXT_COMPATABLE_DEV        0x00000015L
...
//
#define ID_DSP_TXT_MODE_UNTESTED         0x00000016L
...
//
#define ID_DSP_TXT_MODE_UNTESTED_RESTART 0x00000017L
...
//  diskette.
//
#define ID_DSP_TXT_BAD_INF               0x00000018L
...
//  <No Fonts>
//
#define ID_DSP_NO_FONTS_AVAIL            0x00000019L
...
//  <No Drivers>
//
#define ID_DSP_NO_DRIVERS_AVAIL          0x0000001AL
...
//
#define ID_DSP_TXT_WRONG_CODE_PAGE       0x0000001BL
...
//  Change System Font
//
#define ID_DSP_TXT_CHANGE_FONT           0x0000001CL
...
//  installing Windows.
//
#define ID_DSP_TXT_FONT_IN_SETUP_MODE    0x0000001DL
...
//
#define ID_DSP_TXT_FONT_LATER            0x0000001EL
...
//
#define ID_DSP_TXT_NEW_FONT              0x0000001FL
...
//  Change Settings.
//
#define ID_DSP_TXT_CHANGE_SETTINGS       0x00000020L
...
//
#define ID_DSP_TXT_ADMIN_CHANGE          0x00000021L

//
// MessageId: ID_DSP_TXT_CHANGESETTINGS_FAILED
//
// MessageText:
//
...
//
#define ID_DSP_TXT_CHANGESETTINGS_FAILED 0x00000022L
...
//
#define ID_DSP_TXT_DID_TEST_WARNING      0x00000023L
...
//  Testing Mode
//
#define ID_DSP_TXT_TEST_MODE             0x00000024L
...
//
#define ID_DSP_TXT_DID_TEST_RESULT       0x00000025L
...
//
#define ID_DSP_TXT_TEST_FAILED           0x00000026L
...
//
#define ID_DSP_TXT_ADMIN_INSTALL         0x00000027L
...
//
#define ID_DSP_TXT_FAIL_LOAD             0x00000028L
...
//
#define ID_DSP_TXT_MISSING_LOAD_PRIV     0x00000029L
...
//  Installing Driver
//
#define ID_DSP_TXT_INSTALL_DRIVER        0x0000002AL
...
//  installing Windows.
//
#define ID_DSP_TXT_DRIVER_IN_SETUP_MODE  0x0000002BL
...
//
#define ID_DSP_TXT_AUTODETECT            0x0000002CL
...
//
#define ID_DSP_TXT_AUTODETECT_PROCEED    0x0000002DL
...
//  anyway?
//
#define ID_DSP_TXT_INSTALL_WARN          0x0000002EL
...
//
#define ID_DSP_TXT_DRIVER_INSTALLED      0x0000002FL
...
//
#define ID_DSP_TXT_DRIVER_INSTALLED_FAILED 0x00000030L
...
//
#define ID_DSP_TXT_DRIVER_PREINSTALLED_FAILED 0x00000031L
...
//  Display Settings
//
#define ID_DSP_TXT_SETTINGS              0x00000032L
...
//
#define ID_DSP_TXT_SETUP_SAVE            0x00000033L
...
//  Third-party Drivers.
//
#define ID_DSP_TXT_THIRD_PARTY           0x00000034L
...
//
#define ID_DSP_TXT_THIRD_PARTY_DRIVER    0x00000035L
...
//
#define MSG_CONFIGURATION_PROBLEM        0x00000036L
...
//
#define MSG_INVALID_NEW_DRIVER           0x00000037L
...
//  your preferred display resolution.
//
#define MSG_INVALID_DEFAULT_DISPLAY_MODE 0x00000038L
...
//
#define MSG_INVALID_DISPLAY_DRIVER       0x00000039L
...
//
#define MSG_INVALID_OLD_DISPLAY_DRIVER   0x0000003AL
...
//
#define MSG_INVALID_16COLOR_DISPLAY_MODE 0x0000003BL
...
//  your preferred display resolution.
//
#define MSG_INVALID_DISPLAY_MODE         0x0000003CL
...
//
#define MSG_INVALID_CONFIGURATION        0x0000003DL

//
// MessageId: MSG_MULTI_DEVICE_NOT_CONFIGURED
//
// MessageText:
//
...
//
#define MSG_MULTI_DEVICE_NOT_CONFIGURED  0x0000003EL

//
// MessageId: MSG_MULTI_NO_REPOSITION
//
// MessageText:
//
...
//
#define MSG_MULTI_NO_REPOSITION          0x0000003FL

//
// MessageId: MSG_MULTI_BAD_COLORS
//
// MessageText:
//
...
//
#define MSG_MULTI_BAD_COLORS             0x00000040L

//
// MessageId: ID_DSP_CUSTOM_FONTS
//
// MessageText:
//
//  Other...
//
#define ID_DSP_CUSTOM_FONTS              0x00000041L

//
// MessageId: ID_ADP_SHEET_TITLE
//
// MessageText:
//
//  Advanced Display Properties
//
#define ID_ADP_SHEET_TITLE               0x00000042L

//
// MessageId: ID_DSP_NORMAL_FONTSIZE_TEXT
//
// MessageText:
//
//  Normal size (%1!d! dpi)
//
#define ID_DSP_NORMAL_FONTSIZE_TEXT      0x00000043L

//
// MessageId: ID_DSP_CUSTOM_FONTSIZE_TEXT
//
// MessageText:
//
//  %1!d!%% normal size (%2!d! dpi)
//
#define ID_DSP_CUSTOM_FONTSIZE_TEXT      0x00000044L
